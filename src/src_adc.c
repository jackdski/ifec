...
void init_adc(void) {
    ...
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER1, ADC_TRIGGER_CPU1_TINT2, ADC_CH_ADCIN1, 15);    // Battery V - Pin 30
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER2, ADC_TRIGGER_CPU1_TINT2, ADC_CH_ADCIN4, 15);    // MPPT V - Pin 46
    ADC_setupSOC(ADCA_BASE, ADC_SOC_NUMBER3, ADC_TRIGGER_CPU1_TINT2, ADC_CH_ADCIN3, 15);    // MPPT I - Pin 69
